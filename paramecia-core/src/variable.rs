...
// weights and being modified by optimizers like QZO via the `set()` method.
...
/// whereas tensors are immutable. Used by optimizers like QZO via the `set()` method.
#[derive(Clone, Debug)]
...
impl Var {
    pub fn zeros<S: Into<Shape>>(shape: S, dtype: DType, device: &Device) -> Result<Self> {
        let inner = Tensor::zeros_impl(shape, dtype, device)?;
        Ok(Self(inner))
    }

    pub fn ones<S: Into<Shape>>(shape: S, dtype: DType, device: &Device) -> Result<Self> {
        let inner = Tensor::ones_impl(shape, dtype, device)?;
        Ok(Self(inner))
    }
    ...
    pub fn rand_f64<S: Into<Shape>>(
        ...
        let inner = Tensor::rand_f64_impl(lo, up, s, dtype, device)?;
        Ok(Self(inner))
    }
    ...
    pub fn randn_f64<S: Into<Shape>>(
        ...
        let inner = Tensor::randn_f64_impl(mean, std, s, dtype, device)?;
        Ok(Self(inner))
    }
    ...
    pub fn rand<S: Into<Shape>, T: crate::FloatDType>(
        ...
        let inner = Tensor::rand_impl(lo, up, s, device)?;
        Ok(Self(inner))
    }
    ...
    pub fn randn<S: Into<Shape>, T: crate::FloatDType>(
        ...
        let inner = Tensor::randn_impl(mean, std, s, device)?;
        Ok(Self(inner))
    }
    ...
    pub fn new<A: crate::device::NdArray>(array: A, device: &Device) -> Result<Self> {
        ...
        let inner = Tensor::new_impl(array, shape, device)?;
        Ok(Self(inner))
    }
    ...
    pub fn from_vec<S: Into<Shape>, D: crate::WithDType>(
        ...
        let inner = Tensor::from_vec_impl(data, shape, device)?;
        Ok(Self(inner))
    }
    ...
    pub fn from_slice<S: Into<Shape>, D: crate::WithDType>(
        ...
        let inner = Tensor::new_impl(array, shape.into(), device)?;
        Ok(Self(inner))
    }
