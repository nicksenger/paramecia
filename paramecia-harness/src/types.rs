...
impl AgentStats {
    ...
    pub fn add_message_tokens(&mut self, msg: &paramecia_text::LlmMessage) {
    ...
    pub fn calculate_context_tokens(messages: &[paramecia_text::LlmMessage]) -> u32 {
        messages
            .iter()
