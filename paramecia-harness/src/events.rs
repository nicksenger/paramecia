...
pub enum AgentEvent {
    ...
    /// Context token usage updated.
    ContextTokens(ContextTokensEvent),
    /// Compaction started.
...
pub struct AssistantEvent {
    ...
    pub content: String,
    /// Current context tokens (if known).
    #[serde(default)]
...
/// Event for context token updates.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ContextTokensEvent {
