use crate::source::{
    AFFINE, BINARY, CAST, CONV, DELTANET, FILL, FLASH_ATTN_Q8, INDEXING, MLX_GEMM, MLX_SORT,
    QUANTIZED, QUZO_FUSED, QUZO_PERTURB, RANDOM, REDUCE, SDPA, SORT, TERNARY, UNARY,
};
...
impl Kernels {
    ...
    fn get_library_source(&self, source: Source) -> &'static str {
        match source {
            ...
            Source::Unary => UNARY,
            Source::Sdpa => SDPA,
            Source::QuzoPerturb => QUZO_PERTURB,
            Source::FlashAttnQ8 => FLASH_ATTN_Q8,
            Source::QuzoFused => QUZO_FUSED,
        }
    }
