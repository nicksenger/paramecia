...
// batch size = 1
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_0_q8_1_cuda1(
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_1_q8_1_cuda1(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_0_q8_1_cuda1(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_1_q8_1_cuda1(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q8_0_q8_1_cuda1(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q2_K_q8_1_cuda1(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q3_K_q8_1_cuda1(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_K_q8_1_cuda1(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_K_q8_1_cuda1(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q6_K_q8_1_cuda1(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
// batch size = 2
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_0_q8_1_cuda2(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_1_q8_1_cuda2(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_0_q8_1_cuda2(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_1_q8_1_cuda2(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q8_0_q8_1_cuda2(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q2_K_q8_1_cuda2(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q3_K_q8_1_cuda2(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_K_q8_1_cuda2(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_K_q8_1_cuda2(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q6_K_q8_1_cuda2(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
// batch size = 3
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_0_q8_1_cuda3(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_1_q8_1_cuda3(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_0_q8_1_cuda3(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_1_q8_1_cuda3(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q8_0_q8_1_cuda3(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q2_K_q8_1_cuda3(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q3_K_q8_1_cuda3(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_K_q8_1_cuda3(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_K_q8_1_cuda3(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q6_K_q8_1_cuda3(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
// batch size = 4
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_0_q8_1_cuda4(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_1_q8_1_cuda4(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_0_q8_1_cuda4(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_1_q8_1_cuda4(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q8_0_q8_1_cuda4(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q2_K_q8_1_cuda4(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q3_K_q8_1_cuda4(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_K_q8_1_cuda4(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_K_q8_1_cuda4(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q6_K_q8_1_cuda4(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
// batch size = 5
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q4_0_q8_1_cuda5(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q4_1_q8_1_cuda5(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q5_0_q8_1_cuda5(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q5_1_q8_1_cuda5(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q8_0_q8_1_cuda5(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q2_K_q8_1_cuda5(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q3_K_q8_1_cuda5(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q4_K_q8_1_cuda5(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q5_K_q8_1_cuda5(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q6_K_q8_1_cuda5(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
// batch size = 6
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q4_0_q8_1_cuda6(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q4_1_q8_1_cuda6(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q5_0_q8_1_cuda6(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q5_1_q8_1_cuda6(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q8_0_q8_1_cuda6(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q2_K_q8_1_cuda6(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q3_K_q8_1_cuda6(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q4_K_q8_1_cuda6(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q5_K_q8_1_cuda6(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q6_K_q8_1_cuda6(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
// batch size = 7
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q4_0_q8_1_cuda7(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q4_1_q8_1_cuda7(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q5_0_q8_1_cuda7(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q5_1_q8_1_cuda7(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q8_0_q8_1_cuda7(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q2_K_q8_1_cuda7(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q3_K_q8_1_cuda7(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q4_K_q8_1_cuda7(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q5_K_q8_1_cuda7(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q6_K_q8_1_cuda7(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
// batch size = 8
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q4_0_q8_1_cuda8(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q4_1_q8_1_cuda8(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q5_0_q8_1_cuda8(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q5_1_q8_1_cuda8(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q8_0_q8_1_cuda8(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q2_K_q8_1_cuda8(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q3_K_q8_1_cuda8(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q4_K_q8_1_cuda8(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q5_K_q8_1_cuda8(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
extern "C" __global__ __launch_bounds__(64, 1) void mul_mat_vec_q6_K_q8_1_cuda8(
    const void * vx, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
...
// =============================================================================
// Fused SwiGLU MMVQ: silu(gate @ x) * (up @ x) in a single kernel pass
// =============================================================================
// Computes both gate and up dot products simultaneously, sharing the quantized
// input y across both. Applies SwiGLU activation in-register, avoiding
// intermediate storage and extra kernel launches.
// Only for batch_size=1 (single-token decode).

template <int qk, int qi, typename block_q_t, int vdr, vec_dot_q_cuda_t vec_dot_q_cuda>
static __device__ void mul_mat_vec_q_swiglu(
    ...
    for (int kbx = tid / (qi/vdr); kbx < blocks_per_row_x; kbx += blocks_per_iter) {
        ...
        tmp_gate += vec_dot_q_cuda(
            &x_gate[kbx + row0*blocks_per_row_x], &y[kby], kqs);
        tmp_up += vec_dot_q_cuda(
            &x_up[kbx + row0*blocks_per_row_x], &y[kby], kqs);
    }

    __shared__ float shared_gate[nwarps-1 > 0 ? nwarps-1 : 1][WARP_SIZE];
    __shared__ float shared_up[nwarps-1 > 0 ? nwarps-1 : 1][WARP_SIZE];

    if (threadIdx.y > 0) {
        shared_gate[threadIdx.y-1][threadIdx.x] = tmp_gate;
        shared_up[threadIdx.y-1][threadIdx.x] = tmp_up;
    }
    __syncthreads();
    if (threadIdx.y > 0) {
        return;
...
#pragma unroll
    for (int l = 0; l < nwarps-1; ++l) {
        tmp_gate += shared_gate[l][threadIdx.x];
        tmp_up   += shared_up[l][threadIdx.x];
    }
    tmp_gate = warp_reduce_sum(tmp_gate);
    tmp_up   = warp_reduce_sum(tmp_up);

    if (threadIdx.x == 0) {
        // SwiGLU: silu(gate) * up where silu(x) = x * sigmoid(x)
        float gate_silu = tmp_gate / (1.0f + expf(-tmp_gate));
        dst[row0] = gate_silu * tmp_up;
    }
}

extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_0_q8_1_swiglu(
    const void * vx_gate, const void * vx_up, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
    mul_mat_vec_q_swiglu<QK4_0, QI4_0, block_q4_0, VDR_Q4_0_Q8_1_MMVQ, vec_dot_q4_0_q8_1>
        (vx_gate, vx_up, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}

extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_1_q8_1_swiglu(
    const void * vx_gate, const void * vx_up, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
    mul_mat_vec_q_swiglu<QK4_1, QI4_1, block_q4_1, VDR_Q4_1_Q8_1_MMVQ, vec_dot_q4_1_q8_1>
        (vx_gate, vx_up, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}

extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_0_q8_1_swiglu(
    const void * vx_gate, const void * vx_up, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
    mul_mat_vec_q_swiglu<QK5_0, QI5_0, block_q5_0, VDR_Q5_0_Q8_1_MMVQ, vec_dot_q5_0_q8_1>
        (vx_gate, vx_up, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}

extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_1_q8_1_swiglu(
    const void * vx_gate, const void * vx_up, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
    mul_mat_vec_q_swiglu<QK5_1, QI5_1, block_q5_1, VDR_Q5_1_Q8_1_MMVQ, vec_dot_q5_1_q8_1>
        (vx_gate, vx_up, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}

extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q8_0_q8_1_swiglu(
    const void * vx_gate, const void * vx_up, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
    mul_mat_vec_q_swiglu<QK8_0, QI8_0, block_q8_0, VDR_Q8_0_Q8_1_MMVQ, vec_dot_q8_0_q8_1>
        (vx_gate, vx_up, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}

extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q2_K_q8_1_swiglu(
    const void * vx_gate, const void * vx_up, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
    mul_mat_vec_q_swiglu<QK_K, QI2_K, block_q2_K, VDR_Q2_K_Q8_1_MMVQ, vec_dot_q2_K_q8_1>
        (vx_gate, vx_up, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}

extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q3_K_q8_1_swiglu(
    const void * vx_gate, const void * vx_up, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
    mul_mat_vec_q_swiglu<QK_K, QI3_K, block_q3_K, VDR_Q3_K_Q8_1_MMVQ, vec_dot_q3_K_q8_1>
        (vx_gate, vx_up, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}

extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q4_K_q8_1_swiglu(
    const void * vx_gate, const void * vx_up, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
    mul_mat_vec_q_swiglu<QK_K, QI4_K, block_q4_K, VDR_Q4_K_Q8_1_MMVQ, vec_dot_q4_K_q8_1>
        (vx_gate, vx_up, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}

extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q5_K_q8_1_swiglu(
    const void * vx_gate, const void * vx_up, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
    mul_mat_vec_q_swiglu<QK_K, QI5_K, block_q5_K, VDR_Q5_K_Q8_1_MMVQ, vec_dot_q5_K_q8_1>
        (vx_gate, vx_up, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}

extern "C" __global__ __launch_bounds__(128, 1) void mul_mat_vec_q6_K_q8_1_swiglu(
    const void * vx_gate, const void * vx_up, const void * vy, float * dst,
    const int ncols_x, const int nrows_x, const int nrows_y, const int nrows_dst) {
    mul_mat_vec_q_swiglu<QK_K, QI6_K, block_q6_K, VDR_Q6_K_Q8_1_MMVQ, vec_dot_q6_K_q8_1>
        (vx_gate, vx_up, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
...
// Row-wise Q8_0 quantization without MATRIX_ROW_PADDING.
// Input layout: [rows, kx] contiguous f32.
// Output layout: [rows, kx / QK8_0] contiguous block_q8_0.
extern "C" __global__ void quantize_q8_0_rowwise(const float * __restrict__ x, void * __restrict__ vy, const int kx) {
    ...
    const int col = blk * QK8_0 + lane;
    const float xi = x[row * kx + col];
    ...
    const int out_block = row * (kx / QK8_0) + blk;
    y[out_block].qs[lane] = q;
...
// =============================================================================
// QZO (Quantized Zeroth-Order Optimization) Kernels
// =============================================================================
// These kernels support memory-efficient fine-tuning by:
// 1. Extracting scaling factors from quantized blocks
// 2. Dequantizing with custom (trainable) scaling factors

// -----------------------------------------------------------------------------
// Scale Extraction Kernels
// -----------------------------------------------------------------------------

extern "C" __global__ void extract_scales_q4_0(
    ...
    if (block_idx < num_blocks) {
        scales[block_idx] = __half2float(blocks[block_idx].d);
    }
}

extern "C" __global__ void extract_scales_q4_1(
    ...
    const int block_idx = blockIdx.x * blockDim.x + threadIdx.x;
    if (block_idx < num_blocks) {
        scales[block_idx] = __half2float(blocks[block_idx].dm.x);
    }
}

extern "C" __global__ void extract_scales_q5_0(
...
extern "C" __global__ void extract_scales_q5_1(
...
extern "C" __global__ void extract_scales_q8_0(
...
extern "C" __global__ void extract_scales_q2_K(
...
extern "C" __global__ void extract_scales_q3_K(
...
extern "C" __global__ void extract_scales_q4_K(
    ...
    if (block_idx < num_blocks) {
#ifdef GGML_QKK_64
        scales[block_idx] = __half2float(blocks[block_idx].dm[0]);
#else
        scales[block_idx] = __half2float(blocks[block_idx].dm.x);
#endif
    }
...
extern "C" __global__ void extract_scales_q5_K(
...
extern "C" __global__ void extract_scales_q6_K(
...
// -----------------------------------------------------------------------------
// Scale Modification Kernels
// -----------------------------------------------------------------------------
// These kernels multiply each block's scale by a corresponding multiplier.
// Used for QZO fine-tuning where scales are trainable parameters.

extern "C" __global__ void modify_scales_q4_0(
    ...
    const int block_idx = blockIdx.x * blockDim.x + threadIdx.x;
    if (block_idx < num_blocks) {
        block_q4_0* blocks = (block_q4_0*)data;
        half current = blocks[block_idx].d;
        blocks[block_idx].d = __float2half(__half2float(current) * multipliers[block_idx]);
    }
}

extern "C" __global__ void modify_scales_q4_1(
    uint8_t* __restrict__ data,
    const float* __restrict__ multipliers,
    const int num_blocks
) {
    const int block_idx = blockIdx.x * blockDim.x + threadIdx.x;
    if (block_idx < num_blocks) {
        block_q4_1* blocks = (block_q4_1*)data;
        half current = blocks[block_idx].dm.x;
        blocks[block_idx].dm.x = __float2half(__half2float(current) * multipliers[block_idx]);
    }
}

extern "C" __global__ void modify_scales_q5_0(
    uint8_t* __restrict__ data,
    const float* __restrict__ multipliers,
    const int num_blocks
) {
    const int block_idx = blockIdx.x * blockDim.x + threadIdx.x;
    if (block_idx < num_blocks) {
        block_q5_0* blocks = (block_q5_0*)data;
        half current = blocks[block_idx].d;
        blocks[block_idx].d = __float2half(__half2float(current) * multipliers[block_idx]);
    }
}

extern "C" __global__ void modify_scales_q5_1(
    uint8_t* __restrict__ data,
    const float* __restrict__ multipliers,
    const int num_blocks
) {
    const int block_idx = blockIdx.x * blockDim.x + threadIdx.x;
    if (block_idx < num_blocks) {
        block_q5_1* blocks = (block_q5_1*)data;
        half current = blocks[block_idx].dm.x;
        blocks[block_idx].dm.x = __float2half(__half2float(current) * multipliers[block_idx]);
    }
}

extern "C" __global__ void modify_scales_q8_0(
    uint8_t* __restrict__ data,
    const float* __restrict__ multipliers,
    const int num_blocks
) {
    const int block_idx = blockIdx.x * blockDim.x + threadIdx.x;
    if (block_idx < num_blocks) {
        block_q8_0* blocks = (block_q8_0*)data;
        half current = blocks[block_idx].d;
        blocks[block_idx].d = __float2half(__half2float(current) * multipliers[block_idx]);
    }
}

extern "C" __global__ void modify_scales_q2_K(
    uint8_t* __restrict__ data,
    const float* __restrict__ multipliers,
    const int num_blocks
) {
    const int block_idx = blockIdx.x * blockDim.x + threadIdx.x;
    if (block_idx < num_blocks) {
        // block_q2_K: scales[QK_K/16], qs[QK_K/4], half2 dm (at the end)
        block_q2_K* blocks = (block_q2_K*)data;
        half current = blocks[block_idx].dm.x;
        blocks[block_idx].dm.x = __float2half(__half2float(current) * multipliers[block_idx]);
    }
}

extern "C" __global__ void modify_scales_q3_K(
    uint8_t* __restrict__ data,
    const float* __restrict__ multipliers,
    const int num_blocks
) {
    const int block_idx = blockIdx.x * blockDim.x + threadIdx.x;
    if (block_idx < num_blocks) {
        // block_q3_K: hmask[], qs[], scales[], half d (at the end)
        block_q3_K* blocks = (block_q3_K*)data;
        half current = blocks[block_idx].d;
        blocks[block_idx].d = __float2half(__half2float(current) * multipliers[block_idx]);
    }
}

extern "C" __global__ void modify_scales_q4_K(
    uint8_t* __restrict__ data,
    const float* __restrict__ multipliers,
    const int num_blocks
) {
    const int block_idx = blockIdx.x * blockDim.x + threadIdx.x;
    if (block_idx < num_blocks) {
        block_q4_K* blocks = (block_q4_K*)data;
#if QK_K == 256
        // dm is half2: x = d (scale), y = m (min)
        half current = blocks[block_idx].dm.x;
        blocks[block_idx].dm.x = __float2half(__half2float(current) * multipliers[block_idx]);
#else
        half current = blocks[block_idx].dm[0];
        blocks[block_idx].dm[0] = __float2half(__half2float(current) * multipliers[block_idx]);
#endif
    }
}

extern "C" __global__ void modify_scales_q5_K(
    uint8_t* __restrict__ data,
    const float* __restrict__ multipliers,
    const int num_blocks
) {
    const int block_idx = blockIdx.x * blockDim.x + threadIdx.x;
    if (block_idx < num_blocks) {
        block_q5_K* blocks = (block_q5_K*)data;
#if QK_K == 256
        half current = blocks[block_idx].dm.x;
        blocks[block_idx].dm.x = __float2half(__half2float(current) * multipliers[block_idx]);
#else
...
extern "C" __global__ void modify_scales_q6_K(
    uint8_t* __restrict__ data,
    const float* __restrict__ multipliers,
    const int num_blocks
) {
    const int block_idx = blockIdx.x * blockDim.x + threadIdx.x;
    if (block_idx < num_blocks) {
        block_q6_K* blocks = (block_q6_K*)data;
        half current = blocks[block_idx].d;
        blocks[block_idx].d = __float2half(__half2float(current) * multipliers[block_idx]);
    }
}

extern "C" __global__ void modify_scales_q8_K(
    uint8_t* __restrict__ data,
    const float* __restrict__ multipliers,
    const int num_blocks
) {
    const int block_idx = blockIdx.x * blockDim.x + threadIdx.x;
    if (block_idx < num_blocks) {
        block_q8_K* blocks = (block_q8_K*)data;
        // Q8K uses float for scale, not half
        float current = blocks[block_idx].d;
        blocks[block_idx].d = current * multipliers[block_idx];
    }
}

// =============================================================================
// F16 Output Kernels for Performance
// =============================================================================
// These kernels output directly to F16, avoiding a separate F32->F16 conversion pass.
// Internal computation stays in F32 for numerical stability.

#if __CUDA_ARCH__ >= 530

// Templated indexed_moe_forward with configurable output type
template <int qk, int qi, typename block_q_t, int vdr, vec_dot_q_cuda_t vec_dot_q_cuda, typename output_t>
__device__ void indexed_moe_forward_typed(
    const void * __restrict__ all_weights,
    const void * __restrict__ all_inputs,
    const unsigned int * __restrict__ indices,
    output_t * __restrict__ all_outputs,
    const int n,
    const int k,
    const int batch,
    const int topk,
    ...
    const void * current_input_ptr  = (const char *)all_inputs  + input_idx * input_task_stride_bytes;
    const void * current_weight_ptr = (const char *)all_weights + expert_id * weight_expert_stride_bytes;
    output_t * current_output_ptr = all_outputs + task_id * output_task_stride_elems;
    ...
    if (threadIdx.y == 0) {
        ...
        tmp = warp_reduce_sum(tmp);
        if (threadIdx.x == 0) {
            // Cast to output type (F32 or F16)
            current_output_ptr[row0] = (output_t)tmp;
        }
    }
}

// F16 output variants of indexed_moe_forward
extern "C" __global__ void indexed_moe_forward_q2k_q8_1_f16(
    const void * __restrict__ all_weights,
    const void * __restrict__ all_inputs,
    const unsigned int * __restrict__ indices,
    __half * __restrict__ all_outputs,
    const int n, const int k, const int batch, const int topk,
    const int k_padded, const int input_dim1) {
    indexed_moe_forward_typed<QK_K, QI2_K, block_q2_K, VDR_Q2_K_Q8_1_MMVQ, vec_dot_q2_K_q8_1, __half>
        (all_weights, all_inputs, indices, all_outputs, n, k, batch, topk, k_padded, input_dim1);     
}

extern "C" __global__ void indexed_moe_forward_q3k_q8_1_f16(
    const void * __restrict__ all_weights,
    const void * __restrict__ all_inputs,
    const unsigned int * __restrict__ indices,
    __half * __restrict__ all_outputs,
    const int n, const int k, const int batch, const int topk,
    const int k_padded, const int input_dim1) {
    indexed_moe_forward_typed<QK_K, QI3_K, block_q3_K, VDR_Q3_K_Q8_1_MMVQ, vec_dot_q3_K_q8_1, __half>
        (all_weights, all_inputs, indices, all_outputs, n, k, batch, topk, k_padded, input_dim1);     
}

extern "C" __global__ void indexed_moe_forward_q4k_q8_1_f16(
    const void * __restrict__ all_weights,
    const void * __restrict__ all_inputs,
    const unsigned int * __restrict__ indices,
    __half * __restrict__ all_outputs,
    const int n, const int k, const int batch, const int topk,
    const int k_padded, const int input_dim1) {
    indexed_moe_forward_typed<QK_K, QI4_K, block_q4_K, VDR_Q4_K_Q8_1_MMVQ, vec_dot_q4_K_q8_1, __half>
        (all_weights, all_inputs, indices, all_outputs, n, k, batch, topk, k_padded, input_dim1);     
}

extern "C" __global__ void indexed_moe_forward_q5k_q8_1_f16(
    const void * __restrict__ all_weights,
    const void * __restrict__ all_inputs,
    const unsigned int * __restrict__ indices,
    __half * __restrict__ all_outputs,
    const int n, const int k, const int batch, const int topk,
    const int k_padded, const int input_dim1) {
    indexed_moe_forward_typed<QK_K, QI5_K, block_q5_K, VDR_Q5_K_Q8_1_MMVQ, vec_dot_q5_K_q8_1, __half>
        (all_weights, all_inputs, indices, all_outputs, n, k, batch, topk, k_padded, input_dim1);     
}

extern "C" __global__ void indexed_moe_forward_q6k_q8_1_f16(
    const void * __restrict__ all_weights,
    const void * __restrict__ all_inputs,
    const unsigned int * __restrict__ indices,
    __half * __restrict__ all_outputs,
    const int n, const int k, const int batch, const int topk,
    const int k_padded, const int input_dim1) {
    indexed_moe_forward_typed<QK_K, QI6_K, block_q6_K, VDR_Q6_K_Q8_1_MMVQ, vec_dot_q6_K_q8_1, __half>
        (all_weights, all_inputs, indices, all_outputs, n, k, batch, topk, k_padded, input_dim1);     
}

extern "C" __global__ void indexed_moe_forward_q8_0_q8_1_f16(
    const void * __restrict__ all_weights,
    const void * __restrict__ all_inputs,
    const unsigned int * __restrict__ indices,
    __half * __restrict__ all_outputs,
    const int n, const int k, const int batch, const int topk,
    const int k_padded, const int input_dim1) {
    indexed_moe_forward_typed<QK8_0, QI8_0, block_q8_0, VDR_Q8_0_Q8_1_MMVQ, vec_dot_q8_0_q8_1, __half>
        (all_weights, all_inputs, indices, all_outputs, n, k, batch, topk, k_padded, input_dim1);     
}

// =============================================================================
// F16 Output Matmul-Vector Kernels
// =============================================================================
// These kernels quantize F16 input to Q8_1 and output directly to F16.

// Quantize F16 input to Q8_1 (similar to quantize_q8_1 but for F16 input)
__device__ void quantize_q8_1_row_f16(
    ...
    const int tid = threadIdx.x;
    const int num_blocks = k_padded / QK8_1;
    
    for (int block_id = tid; block_id < num_blocks; block_id += blockDim.x) {
        const int base = block_id * QK8_1;
        ...
        for (int i = 0; i < QK8_1; ++i) {
            float v = (base + i < k) ? __half2float(x[base + i]) : 0.0f;
            vals[i] = v;
        ...
        yq[block_id].ds = __floats2half2_rn(d, sum);
    }
}

// Templated mul_mat_vec with F16 input and output
template<typename vec_dot_fn, typename block_q_t>
__device__ void mul_mat_vec_q_q8_1_f16_impl(
    ...
    block_q8_1* y_quant = (block_q8_1*)smem;
    
    const int row = blockIdx.x;
    if (row >= nrows) return;
    
    // Quantize input row to Q8_1 in shared memory
    const int num_blocks_y = k_padded / QK8_1;
    
    // Each thread helps quantize
    for (int b = threadIdx.x; b < num_blocks_y; b += blockDim.x) {
        const int base = b * QK8_1;
        float amax = 0.0f;
        float vals[QK8_1];
        
        #pragma unroll
        for (int i = 0; i < QK8_1; ++i) {
            float v = (base + i < ncols) ? __half2float(y[base + i]) : 0.0f;
            vals[i] = v;
            amax = fmaxf(amax, fabsf(v));
        }
        ...
        y_quant[b].ds = __floats2half2_rn(d, sum);
    }
    __syncthreads();
    
    // Now compute the dot product (simplified - full implementation would use warp reduction)
    // This is a placeholder - the actual implementation should match mul_mat_vec_q*_q8_1
    float acc = 0.0f;
    const block_q_t * x = (const block_q_t *)vx;
    const int blocks_per_row = ncols / 32; // QK for most types
    
    // Use warp-parallel dot product
    for (int b = threadIdx.x; b < blocks_per_row; b += blockDim.x) {
        const int by = b * (32 / QK8_1);
        // acc += vec_dot_fn(&x[row * blocks_per_row + b], &y_quant[by], 0);
    }
